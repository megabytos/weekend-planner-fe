...
import { clamp, haversineKm } from '../utils/geo';
import { addMinutes, fmtTime } from '../utils/time';

/**
 * A hook that provides a planner logic.
 * It maintains a list of items (either event or place visits) and a timeline
 * based on the items. It also provides metrics such as total distance, travel time, stay time,
 * and warnings.
 * @param {Object} props - An object containing the origin, win (day window), and mode.
 * @returns {Object} An object containing the items, timeline, metrics, and functions to modify the items.
 */
